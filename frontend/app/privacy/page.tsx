    ...
    <div className="flex min-h-screen flex-col font-sans bg-[#F7F8F6]">
      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12 prose prose-lg prose-slate rtl:prose-invert max-w-none">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            نرسل إلى Google Analytics مسارات صفحات عامة، بالإضافة إلى بيانات
            إجمالية عن التفاعل مع واجهات المتاجر، مثل مشاهدة المنتجات والسلة
            وتثبيت تطبيق العملاء وإنشاء الطلب. لا
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">
            9. إشعارات تطبيق العملاء
          </h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            إذا ثبّت تطبيق العملاء واخترت تفعيل إشعارات الطلبات، نحفظ اشتراك
            الإشعارات بصورة مشفرة ونربط هذا الجهاز بحسابات العملاء التي تحققت
            منها باستخدام رقم الهاتف وكود العميل. نحتفظ في قاعدة البيانات ببصمة
            أحادية الاتجاه لمعرّف الجهاز، وليس المعرّف الأصلي.
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
            تقتصر إشعارات شاشة القفل على اسم المتجر ورقم الطلب وحالته أو وجود
            بديل يحتاج إلى مراجعتك، ولا تتضمن عنوانك أو رقم هاتفك أو أسماء
            المنتجات أو أسباب الإلغاء. يمكنك إيقاف هذه الإشعارات وحذف اشتراك
            الجهاز في أي وقت من صفحة «طلباتي» داخل التطبيق المثبت.
          </p>
