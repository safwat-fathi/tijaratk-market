      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12 prose prose-lg prose-slate rtl:prose-invert max-w-none">
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">
            8. قياس الإعلانات باستخدام Meta
          </h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            بعد موافقتك الصريحة على ملفات التسويق فقط، نستخدم Meta Pixel وواجهة
            Meta Conversions API لقياس ما إذا كانت الإعلانات قد أدت إلى زيارة
            متجر أو إنشاء طلب، وتحسين أداء الحملات الإعلانية. لا يتم تحميل Meta
            Pixel أو إرسال أحداث تسويقية قبل هذه الموافقة.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            الموقع. عند السحب نوقف الأحداث اللاحقة ونطلب من Meta إلغاء الموافقة
            ونحذف معرّفات _fbp و_fbc التي يمكن حذفها من نطاقنا. لا يؤثر رفض هذه
