...
export const publicMarketingPages = [
  ...
  },
  {
    ...
    description:
      "تعرف على باقات تجارتك وقدّم طلب انضمام متجرك للمراجعة والاعتماد، مع تجربة مجانية بعد القبول وبدون عمولة على الطلبات.",
    priority: 0.8,
  },
  {
    path: "/features",
  ...
  {
    path: "/about",
    title: "تجارتك | نظّم طلبات محلك واستقبلها من رابط واحد",
    description:
      "استقبل طلبات محلك من رابط بسيط، تابعها من لوحة تحكم عربية، ووصلك تنبيه واتساب بكل طلب جديد — بدون عمولة على الطلبات.",
    priority: 0.9,
  },
  {
    path: "/ai",
  ...
  },
  {
    ...
    description:
      "سياسة الخصوصية وحماية البيانات الشخصية لمنصة تجارتك وفقاً للقوانين المصرية.",
    priority: 0.3,
  },
  {
    path: "/return-policy",
...
export const pricingPlans = [
  {
    ...
    features: [
      ...
      "خدمة عملاء VIP",
      "ظهور متجرك على جوجل (صفحة نشاط تجاري، خرائط)",
    ],
    buttonText: "قدّم طلب انضمام متجرك",
    highlighted: true,
  },
  {
    name: "باقة الفروع",
...
export const faqs = [
  {
    question: "كيف أنضم إلى تجارتك كتاجر؟",
    answer:
      "أرسل بيانات متجرك من صفحة طلب الانضمام. سيتواصل معك الفريق لمراجعة النشاط وطلب المستندات القانونية، وبعد اعتماد الطلب يمكنك تسجيل الدخول وإكمال إعداد المتجر.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "لا. تجارتك لا يأخذ عمولة على الطلبات. بعد اعتماد طلب المتجر تبدأ التجربة المجانية، ثم يكون السعر من خلال الباقة الشهرية.",
  },
  {
